...
export const COURSE_MODULES: readonly CourseModule[] = [
  ...
  },
  {
    ...
    videos: [
      ...
      "What hormone therapy actually is (and the myths around it)",
      "Non-hormonal medical options worth knowing about",
      "Supplements: what has evidence and what doesn't",
      "Diet and nutrition that actually moves the needle",
